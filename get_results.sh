...
# No       No     No     No     BG     No
perl summarize_results.pl --lmw=15 tri2a
# No       No     Yes    No     BG     No
...
# Yes      No     Yes    No     BG     No
perl summarize_results.pl --lmw=15 tri2b_mc
# Yes      Yes    Yes    No     BG     No
perl summarize_results.pl --lmw=15 tri2b_mc basis_fmllr
# Yes      No     Yes    Yes    BG     No
perl summarize_results.pl --lmw=15 tri2b_mc_mmi_b0.1
# Yes      Yes    Yes    Yes    BG     No
perl summarize_results.pl --lmw=15 tri2b_mc_mmi_b0.1 basis_fmllr
